...
if args.check_b: # means all binners have bins, either duplicated or own
    ...
    if args.bt_cct:
        ...
        dastoolDependencies='module unload maxbin/2.2.7 fraggenescan/1.31 perl/5.20.2 && module load tools gcc/5.4.0 intel/perflibs/2018 R/3.6.1 pullseq/1.0.2 perl/5.24.0 ncbi-blast/2.6.0+ prodigal/2.6.3 das_tool/1.1.2 diamond/0.9.24 usearch/11.0.667'

...
if not (os.path.exists(str(out_dir))):
    ...
    # Call gtdbtk
    gtdbtkCmd='module load tools gtdbtk/1.6.0 prodigal/2.6.3 hmmer/3.2.1 pplacer/1.1.alpha19 fastani/1.1 && gtdbtk classify_wf --genome_dir '+gen_dir+' --extension "fa" --out_dir '+out_dir+' --cpus '+threads+'' #--pplacer_cpus 1'
